...
const App = () => {
  ...
  useEffect(() => {
    ...
    if (token) {
      fetch('http://smartbrain.thomassoard.com:3000/signin', {
        ...
        .then(data => {
          if (data && data.id) {
            fetch(`http://smartbrain.thomassoard.com:3000/profile/${data.id}`, {
              method: 'get',
              headers: {
                'Content-Type': 'application/json',
                'Authorization': token
  ...
  const onButtonSubmit = () => {
    setImageUrl(input);
    fetch('http://smartbrain.thomassoard.com:3000/imageurl', {
      method: 'post',
      headers: {
        'Content-Type': 'application/json',
      ...
      .then(response => {
        if (response) {
          fetch('http://smartbrain.thomassoard.com:3000/image', {
            method: 'put',
            headers: {
              'Content-Type': 'application/json',
              'Authorization': window.sessionStorage.getItem('token')
